    ...
    <section>
        <div class="str">
            <div class="container">
                <div class="row">
                    <div class="home-tit">
                        <h2><span>Popular Agencies</span> near you</h2>
                                ...
                                <li>
                                    <div class="land-pack-grid">
                                        ...
                                        <div class="land-pack-grid-text">
                                            <h4>{{ $sp->ag_name }} <span class="dir-ho-cat">Show All (05 )</span>
                                            </h4>
                                        </div>
                                        <a href="{{ route('ag_details', $sp->ag_slug) }}"
                                            class="land-pack-grid-btn">View all
                                            listings</a>
                                    </div>
                                </li>
                            @endforeach
                ...
                <div class="hom-mpop-main">
                    ...
                    <div class="hom2-cus-sli">
                        <ul class="multiple-items1">
                            ...
                            <li>
                                <div class="testmo hom4-prop-box">
                                    <img src="{{ asset('assets/images/listings/42858pexels-caio-67112.jpg') }}"
                                        alt="">
                                    <div>
                                        <h4>
                            ...
                            <div class="hot-page2-hom-pre">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <a href="listing/automobile--services-new-jersey.html"
                                            class="fclick"></a>
                                    </li>
                                    <!--LISTINGS-->
                                    <!--LISTINGS-->
                            ...
                            <div class="hot-page2-hom-pre">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <a href="listing/online-marketing-training-school.html"
                                            class="fclick"></a>
                                    </li>
                                    <!--LISTINGS-->
                                </ul>
                                ...
                                <div class="eve-box">
                                    ...
                                    <div>
                                        <div class="auth">
                                            ...
                                            <b>Hosted by</b><br>
                                            <h4>Richflayer</h4>
                                            <a target="_blank" href="profile/richflayer.html"
                                                class="fclick"></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="eve-box-list">
                                            ...
                                            <a href="event/cricket-tournament-for-mens.html"
                                                class="fclick"></a>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <div class="eve-box-list">
                                            ...
                                            <a href="event/places-to-hang-out-in-new-york.html"
                                                class="fclick"></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="eve-box-list">
                                            ...
                                            <a href="event/beach-party-in-new-los-angeles.html"
                                                class="fclick"></a>
                                        </div>
                                    </li>
                                </ul>
        ...
        <div class="container">
            ...
            <div class="row wed-foot-link-1">
                ...
                <div class="col-md-4 fot-soc">
                    <h4>SOCIAL MEDIA</h4>
                    <ul>
                        <li><a target="_blank" href="#"><img src="{{ asset('assets/images/social/1.png') }}"
                                    alt=""></a></li>
                        <li><a target="_blank"
                        ...
                        <li><a target="_blank" href="#"><img src="{{ asset('assets/images/social/4.png') }}"
                                    alt=""></a></li>
                        <li><a target="_blank" href="#"><img src="{{ asset('assets/images/social/5.png') }}"
                                    alt=""></a></li>
                    </ul>
                </div>
            </div>
