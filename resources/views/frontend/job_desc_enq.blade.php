            ...
            <div class="container">
                <div class="row">
                    <div class="v3-list-ql-inn">
                        <ul>
                            <li class="active">
                                <a href="#ld-abo"><i class="material-icons">person</i> About </a>
                            </li>
                            <li>
                                <a href="#ld-ser"><i class="material-icons">business_center</i> Services </a>
                            </li>
                            <li>
                                <a href="#ld-gal"><i class="material-icons">photo</i> Gallery </a>
                            </li>
                            <li>
                                <a href="#ld-off"><i class="material-icons">style</i> Offers </a>
                            </li>
                            <li>
                                <a href="#ld-360"><i class="material-icons">camera</i> 360 View </a>
                            </li>
                            <li>
                                <a href="#ld-rev"><i class="material-icons">star_half</i> Write Review </a>
                            </li>
                            <li>
                                <a href="#" data-toggle="modal" data-target="#claim"><i
                ...
                <div class="row">
                    <div class="list-det-fix-inn">
                        <div class="list-fix-pro">
                            <img src="{{ asset('assets/images/listings/70463pexels-gustavo-fring-3985178.jpg') }}"
                                alt="" />
                        </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="list-ban-btn">
                        <ul>
                            ...
                            <li>
                                <span class="cta cta-like ldelik Animatedheartfunc401" data-for="0" data-section="1"
                                    data-num="328" data-item="" data-id="401"> <b class="like-content401">0</b> LIKES</span>
                            </li>
                            <li>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="quote-pop">
                                                    ...
                                                    <form method="post" action="{{ route('enq_submit', $result->id) }}"
                                                        name="all_enquiry_form" id="">
                                                        @csrf
                                                        ...
                                                        <div class="form-group" id="enq_zip">
                                                            <input type="text" name="enq_zip" value="" required="required"
                                                        ...
                                                        <div class="form-group" id="enq_mobile">
                                                            <input type="number" class="form-control" value=""
                                                                name="enq_mobile" placeholder="Enter mobile number *"
                                                        ...
                                                        <button style="" type="" onclick="myFunction()" id="nextButton"
                                                            name="enquiry_submit" class="btn btn-primary">next</button>
                    ...
                    <div id="ld-abo" class="list-pg-lt list-page-com-p">
                        ...
                        <div class="pglist-bg pglist-p-com">
                            <div class="pglist-p-com-ti">
                                <h3><span>About</span> Greys Sloan Memorial Hospital</h3>
                            </div>
                        ...
                        <!--LISTING DETAILS: LEFT PART 6-->
                        <div class="pglist-bg pglist-p-com" style="pointer-events: none; opacity: 0.5;" id="ld-rev">
                            <div class="pglist-p-com-ti">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="list-pg-guar-img"><img
                                                    src="{{ asset('assets/images/icon/g2.png') }}" alt="" /></div>
    ...
    <div class="ani-quo-form">
        ...
        <div class="hom-col-req">
            ...
            <form name="home_slide_enquiry_form" id="home_slide_enquiry_form" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" class="form-control" name="enquiry_source" value="Website" placeholder=""
                    required />
                <div class="form-group">
