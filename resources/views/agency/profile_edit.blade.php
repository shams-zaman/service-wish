    ...
    <div class="row">
        <div class="col-12  mb-4">
            ...
            <div style="width: 100%" class="card  border-0 shadow components-section">
                <div class="card-body">
                    <form method="POST" action="{{ route('agency.profile_update', $profile->id) }}"
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-5   col-sm-6">
                                <div class="mb-3"><label for="Name">Agency Name</label> <small id="emailHelp"
                                    ...
                                    <input type="text" name="ag_name" value="{{ $profile->ag_name }}"
                                        class="form-control" id="ag_name" aria-describedby="emailHelp">
                                    @error('ag_name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group"><input name="address" value="{{ $profile->address }}"
                                            type="text" class="form-control" id="exampleInputIconLeft"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group"><input type="text" class="form-control" name="zip"
                                            value="{{ $profile->zip }}" id="exampleInputIconRight" placeholder="zip"
                                            aria-label="zip">
                                        @error('zip')
                                            <div style="color: red" class="error">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="col-lg-5 offset-lg-1  col-sm-6">
                                <div class="mb-3">
                                    <label class="my-1 me-2" for="cat">Select
                                        Category</label>
                                    <select class="form-select" id="" name="cat" value="" aria-label="">
                                ...
                                <div class="mb-3"><label for="disabledTextInput">Mobile</label>
                                    <input type="number" id="mobile" class="form-control" name="mobile"
                                        value="{{ $profile->mobile }}" placeholder="mobile No:">
                                    @error('mobile')
                                        <div style="color: red" class="error">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-3"><label for="formFile" class="form-label">Default file
                                        input example</label> <input class="form-control" name="sp_cover_img" value=""
                        ...
                        <div class="row  mb-2">
                            <div class="mb-1">
                                ...
                                <textarea class="form-control" name="desc" value="{{ $profile->desc }}" id="about_agency" cols="20"
                                    rows="5">Heloo  </textarea>
                                @error('sp_cover_img')
                                    <div style="color: red" class="error">{{ $message }}</div>
                                @enderror
